    ...
    return (
      <View style={[styles.container, { backgroundColor :'transparent' }]}>
        ...
        >
          <ScrollableTabView
            initialPage={0}
            style={{ backgroundColor: 'transparent', marginBottom: height(2) }}
          ...
          //  tabBarBackgroundColor={{ backgroundColor :'transparent'}}
           // tabBarTextStyle={{ fontSize: width(4.5), color:'#4195f4' }}
            ...
            <View tabLabel='COUPONS' style={styles.itemMainContainer} tabBarTextStyle={ {fontFamily : 'Roboto', fontSize: 30}} >
              {this.renderCouponsData()}
            </View>
            <View tabLabel='STORES' style={styles.itemMainContainer}>
